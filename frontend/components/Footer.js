...
//           <BottomCol title="Resources" items={["Blog", "Sitemap", "Guides"]} />
...
//         {items.slice(0, open ? items.length : 4).map((item, i) => (
//           <Link
//             key={i}
//             href="#"
...
//   return (
//     <div>
//       <h4 className="font-semibold  text-2xl black mb-3">{title}</h4>

//       <ul className="space-y-2">
//         {items.map((item, i) => (
//           <li key={i}>
//             <Link href="#" className="text-gray-900 text-xl">
//               {item}
//             </Link>
//           </li>
//         ))}
