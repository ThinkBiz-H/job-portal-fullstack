      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 mb-8">
          ...
          <div className="flex flex-col sm:flex-row gap-3 w-full lg:w-auto">
            <button
              onClick={fetchMyJobs}
              className="inline-flex items-center justify-center gap-2 px-4 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors"
            >
            ...
            <button
              onClick={() => router.push("/employer/post-job")}
              className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-green-600 to-emerald-600 text-white font-medium rounded-lg hover:from-green-700 hover:to-emerald-700 transition-all shadow-sm"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 mb-8">
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
            ...
            <div className="text-xs text-gray-500 mt-1">Average applicants</div>
          </div>
        </div>
          ...
          <div className="flex flex-col lg:flex-row gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <select
                value={statusFilter}
                onChange={(e) => setStatusFilter(e.target.value)}
                className="px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent outline-none transition bg-white"
              >
              ...
              <div>
                ...
                <ul className="space-y-2 text-sm text-gray-700">
                  <li className="flex items-center gap-2">
                    ...
                    Update job descriptions regularly to keep them fresh and
                    engaging
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle className="w-4 h-4 text-green-500" />
                    Review applications within 48 hours for better candidate
                    experience
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle className="w-4 h-4 text-green-500" />
                    Close filled positions promptly to manage candidate
                    expectations
                  </li>
                </ul>
              </div>
