...
//   // ✅ FIXED: Use logo and coverPhoto from employerProfile
//   const [companyProfile, setCompanyProfile] = useState({
//     // Basic Info
//     companyName: "",
//     tagline: "",
...
//     // ✅ FIXED: These are now in employerProfile
//     logo: "", // profile image
...
//   // 1. FETCH PROFILE FROM BACKEND - ✅ UPDATED
//   const fetchProfile = async () => {
//     try {
//       const savedToken =
//         localStorage.getItem("token") || sessionStorage.getItem("token");
...
//         // ✅ FIXED: Check if employer profile exists
//         if (data.data.userType === "employer" && data.data.profile) {
//           const backendProfile = data.data.profile;

//           // ✅ DEBUG: Pehle check karo kya aa raha hai
//           console.log("Backend Profile Raw:", backendProfile);
//           console.log(
//             "FoundedYear from backend:",
//             backendProfile.foundedYear,
//             typeof backendProfile.foundedYear,
//           );
//           console.log(
//             "CompanySize from backend:",
//             backendProfile.companySize,
//             typeof backendProfile.companySize,
//           );

//           // ✅ FIXED: Merge backend data correctly
//           const mergedProfile = {
//             // Basic Info
//             companyName: backendProfile.companyName || "",
//             tagline: backendProfile.tagline || "",
...
//             phone: backendProfile.phone || data.data.phone || "",
//             website: backendProfile.website || "",
//             // ✅ FIXED: foundedYear ko string mein convert karo
//             foundedYear: backendProfile.foundedYear
//               ? typeof backendProfile.foundedYear === "number"
//                 ? backendProfile.foundedYear.toString()
//                 : String(backendProfile.foundedYear || "")
//               : "",
//             // ✅ FIXED: companySize ko check karo
...
//           console.log("FoundedYear final:", mergedProfile.foundedYear);
//           console.log("CompanySize final:", mergedProfile.companySize);
//         }
//       } else {
//         console.error("Failed to fetch profile:", data.message);
//       }
...
//     }
//   };
//   // 2. SAVE PROFILE TO BACKEND - ✅ UPDATED
//   const handleSaveProfile = async () => {
//     if (!token) {
//       alert("Please login first");
//       router.push("/login");
...
//     try {
//       // ✅ FIXED: Send profile data in correct format
//       const response = await fetch(`${API_BASE_URL}/auth/updateprofile`, {
//         method: "PUT",
//         headers: {
//           "Content-Type": "application/json",
...
//           profile: {
//             ...formData,
//             // Ensure we send email and phone at root level
...
//   // 3. IMAGE UPLOAD FUNCTION - ✅ NEW FUNCTION
...
//     // For now, we'll convert to base64 and save with profile
//     // Later you can create an upload endpoint
//     const reader = new FileReader();
...
//       // Update company profile preview
...
//     // If editing logo or coverPhoto, update preview immediately
//     if (field === "logo" || field === "coverPhoto") {
//       setCompanyProfile((prev) => ({
//         ...prev,
//         [field]: value,
//       }));
...
//   // ✅ FIXED: Updated getVerificationBadge to check correctly
//   const getVerificationBadge = () => {
//     if (companyProfile.verificationLevel === "advanced") {
//       return (
//         <div className="inline-flex items-center gap-1 px-3 py-1 bg-blue-100 text-blue-800 rounded-full text-sm font-medium">
...
//           {/* ✅ ADDED: Logo and Cover Photo URL fields */}
//           <div>
//             <label className="block text-sm font-medium text-gray-700 mb-2">
//               Logo URL
//             </label>
...
//             phone: backendProfile.phone || data.data.phone || "",
//             website: backendProfile.website || "",
//             // ✅ FIXED: Check properly for foundedYear
//             foundedYear: backendProfile.foundedYear
//               ? backendProfile.foundedYear.toString()
//               : "",
//             // ✅ FIXED: companySize from backend or default
//             companySize: backendProfile.companySize || "1-10",
//             companyType: backendProfile.companyType || "",
//             industry: backendProfile.industry || "",
//             headquarters: backendProfile.headquarters || "",
...
//           console.log("Company Size Value:", mergedProfile.companySize);
//           console.log("Founded Year Value:", mergedProfile.foundedYear);
...
//                     <div className="flex items-center gap-1">
//                       <Users size={16} />
//                       <span>{companyProfile.teamSize || "Set team size"}</span>
//                     </div>
//                     <div className="flex items-center gap-1">
//                       <Calendar size={16} />
//                       <span>Since {companyProfile.foundedYear || "Year"}</span>
//                     </div>
//                     <div className="flex items-center gap-1">
//                       <Building size={16} />
//                       <span>
